=== Email Bridge for Sendy with Amazon SES ===
...
**DigitalProductNinja Email Bridge for Sendy** transforms your WordPress dashboard into a professional newsletter creation studio. Forget manual HTML coding—simply search for your posts, drag them into a stunning layout, and send deeply integrated campaigns via Sendy (Amazon SES).
...
1.  Upload the plugin files to the `/wp-content/plugins/digitalproductninja-email-bridge-for-sendy` directory, or install the plugin through the WordPress plugins screen directly.
