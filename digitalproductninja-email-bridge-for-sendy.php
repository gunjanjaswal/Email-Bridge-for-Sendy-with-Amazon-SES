<?php
/**
 * Plugin Name: Email Bridge for Sendy with Amazon SES
 * Plugin URI:  https://github.com/gunjanjaswal/Email-Bridge-for-Sendy-with-Amazon-SES
 ...
 * Text Domain: digitalproductninja-email-bridge-for-sendy
...
class SSSB_Core
{
    ...
    public function register_post_type()
    {
        register_post_type(
            ...
            array(
                'labels'      => array(
                    'name'          => __('Campaigns', 'digitalproductninja-email-bridge-for-sendy'),
                    'singular_name' => __('Campaign', 'digitalproductninja-email-bridge-for-sendy'),
                ),
                'public'      => false,
    ...
    public function add_campaign_columns($columns) {
        $columns['sssb_status'] = __('Status', 'digitalproductninja-email-bridge-for-sendy');
        $columns['sssb_scheduled'] = __('Scheduled For', 'digitalproductninja-email-bridge-for-sendy');
        $columns['sssb_error'] = __('Error', 'digitalproductninja-email-bridge-for-sendy');
        return $columns;
    }
    ...
    {
        // load_plugin_textdomain('digitalproductninja-email-bridge-for-sendy', false, dirname(plugin_basename(__FILE__)) . '/languages');
    }
...
{
    if (strpos($file, 'digitalproductninja-email-bridge-for-sendy.php') !== false) {
        $new_links = array(
...
{
    $settings_link = '<a href="' . admin_url('admin.php?page=simple_sendy_bridge') . '">' . __('Settings', 'digitalproductninja-email-bridge-for-sendy') . '</a>';
