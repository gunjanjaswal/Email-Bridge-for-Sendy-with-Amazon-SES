...
class SSSB_Newsletter_Builder
{
    ...
    public function add_submenu()
    {
        add_submenu_page(
            'simple_sendy_bridge',
            __('Create Newsletter', 'digitalproductninja-email-bridge-for-sendy'),
            __('Create Newsletter', 'digitalproductninja-email-bridge-for-sendy'),
            'manage_options',
    ...
    public function render_page()
    {
        ...
        <div class="wrap sssb-container">
            <h1>
                <?php esc_html_e('Create Newsletter', 'digitalproductninja-email-bridge-for-sendy'); ?>
            </h1>
            ...
            <div class="sssb-flex">
                ...
                <div class="sssb-col-left">
                    <div class="sssb-card">
                        <h2>
                            <?php esc_html_e('Campaign Settings', 'digitalproductninja-email-bridge-for-sendy'); ?>
                        </h2>
                        <p>
                            <label>
                                <?php esc_html_e('Subject Line', 'digitalproductninja-email-bridge-for-sendy'); ?>
                            </label><br>
                            <input type="text" id="sssb-subject" class="widefat" placeholder="Newsletter Subject">
                        </p>
                        <p>
                            <label>
                                <?php esc_html_e('From Name', 'digitalproductninja-email-bridge-for-sendy'); ?>
                            </label><br>
                        ...
                        <p>
                            <label>
                                <?php esc_html_e('From Email', 'digitalproductninja-email-bridge-for-sendy'); ?>
                            </label><br>
                        ...
                        <p>
                            <label>
                                <?php esc_html_e('List ID', 'digitalproductninja-email-bridge-for-sendy'); ?>
                            </label><br>
                    ...
                    <div class="sssb-card">
                        <h2><?php esc_html_e('Design Settings', 'digitalproductninja-email-bridge-for-sendy'); ?></h2>
                        <p>
                            <label><strong><?php esc_html_e('Banner Image', 'digitalproductninja-email-bridge-for-sendy'); ?></strong></label><br>
                            <button class="button"
                                id="sssb-upload-banner"><?php esc_html_e('Select Banner', 'digitalproductninja-email-bridge-for-sendy'); ?></button>
                            <button class="button hidden" id="sssb-remove-banner"
                                style="display:none; color: #a00; border-color: #a00;"><?php esc_html_e('Remove', 'digitalproductninja-email-bridge-for-sendy'); ?></button>
                        <p class="description" style="margin-top: 5px; color: #666; font-style: italic;">
                            <?php esc_html_e('Recommended Size: 600px wide. Keep height under 200px for best results on mobile and desktop.', 'digitalproductninja-email-bridge-for-sendy'); ?>
                        </p>
                        ...
                        <p>
                            <!-- Custom Template Enforced -->
                             ...
                             <span class="description"><?php esc_html_e('Using Custom Template (Hero + Grid)', 'digitalproductninja-email-bridge-for-sendy'); ?></span>
                        </p>
                    </div>

                    <div class="sssb-card">
                        <h2>
                            <?php esc_html_e('Add Posts', 'digitalproductninja-email-bridge-for-sendy'); ?>
                        </h2>
                    ...
                    <div class="sssb-card">
                        <h2>
                            <?php esc_html_e('Selected Posts', 'digitalproductninja-email-bridge-for-sendy'); ?>
                        </h2>
                    ...
                    <div class="sssb-card">
                        <h2>
                            <?php esc_html_e('Actions', 'digitalproductninja-email-bridge-for-sendy'); ?>
                        </h2>
                        <label><input type="radio" name="sssb_send_type" value="draft" checked>
                            <?php esc_html_e('Save as Draft in Sendy', 'digitalproductninja-email-bridge-for-sendy'); ?>
                        </label><br>
                        <label><input type="radio" name="sssb_send_type" value="send">
                            <?php esc_html_e('Send Immediately', 'digitalproductninja-email-bridge-for-sendy'); ?>
                        </label><br>
                        <label><input type="radio" name="sssb_send_type" value="schedule">
                            <?php esc_html_e('Schedule', 'digitalproductninja-email-bridge-for-sendy'); ?>
                        </label>
                        
                        <div id="sssb-schedule-options" style="display:none; margin-top: 10px; padding-left: 20px;">
                            <label><?php esc_html_e('Send Date/Time', 'digitalproductninja-email-bridge-for-sendy'); ?></label><br>
                            <?php
                            ...
                            <p class="description">
                                ...
                                echo esc_html(sprintf(__('Current Server Time: %s', 'digitalproductninja-email-bridge-for-sendy'), current_time('mysql')));
                                ?>
                                <br>
                                <?php
                                /* translators: %s: Timezone */
                                echo esc_html(sprintf(__('Timezone: %s', 'digitalproductninja-email-bridge-for-sendy'), $timezone));
                                ?>
                            </p>
                        </div>
                        ...
                        <button id="sssb-create-campaign" class="button button-primary large">
                            <?php esc_html_e('Create Campaign', 'digitalproductninja-email-bridge-for-sendy'); ?>
                        </button>
                    </div>

                    <div class="sssb-card">
                        <h3><?php esc_html_e('Support & Contact', 'digitalproductninja-email-bridge-for-sendy'); ?></h3>
                        <p>
                        ...
                        <p style="margin-top:15px;">
                            <strong><?php esc_html_e('Email:', 'digitalproductninja-email-bridge-for-sendy'); ?></strong> <a
                                href="mailto:hello@gunjanjaswal.me" style="color: #2271b1 !important; text-decoration: underline;">hello@gunjanjaswal.me</a><br>
                            <strong><?php esc_html_e('Website:', 'digitalproductninja-email-bridge-for-sendy'); ?></strong> <a
                ...
                <div class="sssb-col-right">
                    ...
                    <div class="sssb-card">
                        <h2>
                            <?php esc_html_e('Email Preview', 'digitalproductninja-email-bridge-for-sendy'); ?>
                        </h2>
                        <div id="sssb-preview-content">
                            <p style="text-align:center; color:#999;">
                                <?php esc_html_e('Add posts to see preview', 'digitalproductninja-email-bridge-for-sendy'); ?>
                            </p>
                        </div>
                    </div>
                </div>
